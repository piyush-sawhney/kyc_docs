...
public interface DocumentsApi {
    ...
    ResponseEntity<ApiResponse<Document>> rotateImage(@PathVariable String id, @RequestBody Map<String, Integer> body);

    @Operation(summary = "Crop image")
    @PostMapping("/documents/{id}/crop")
    ResponseEntity<ApiResponse<Document>> cropImage(@PathVariable String id, @RequestBody Map<String, Integer> body);
